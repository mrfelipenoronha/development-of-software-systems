...
INSERT INTO laboratorio_usuario (id_usuario, instituicao, login, senha)
...
INSERT INTO laboratorio_pessoa (id_pessoa, nome, cpf, data_nasc, email)
VALUES (3, 'Bruna Bazaluk', '85141739015', TO_DATE('12/09/1997', 'DD/MM/YYYY'), 'bruna@usp.br');
INSERT INTO laboratorio_usuario (id_usuario, instituicao, login, senha)
VALUES (3, 'IME', 'bzaluk', '11111111');

INSERT INTO laboratorio_pessoa (id_pessoa, nome, cpf, data_nasc, telefone)
...
INSERT INTO laboratorio_usuario (id_usuario, login, senha)
...
-- INTO PERFIL
INSERT INTO laboratorio_perfil (id_perfil, codigo, data_criacao, tipo)
VALUES (1, '0001', TO_DATE('28/10/2018', 'DD/MM/YYYY'), 'aluno');

INSERT INTO laboratorio_perfil (id_perfil, codigo, data_criacao, tipo)
VALUES (2, '0002', TO_DATE('28/10/2018', 'DD/MM/YYYY'), 'pesquisador');

INSERT INTO laboratorio_perfil (id_perfil, codigo, tipo)
...
-- INTO ACESSA
INSERT INTO laboratorio_ACESSA (id_usuario, id_perfil)
VALUES (1, 2);
...
-- INTO SERVICO
INSERT INTO laboratorio_servico (id_servico, nome, classe, descricao)
VALUES (1, 'consulta exame COVID-19', 'V', 'recupera dados acerca de um exame de COVID-19');

INSERT INTO laboratorio_servico (id_servico, nome, classe, descricao)
VALUES (2, 'solicita exame COVID-19', 'I', 'solicita novo exame de COVID-19');

INSERT INTO laboratorio_servico (id_servico, nome, classe, descricao)
VALUES (3, 'solicita exame Sarampo', 'I', 'solicita novo exame de Sarampo');

INSERT INTO laboratorio_servico (id_servico, nome, classe, descricao)
VALUES (4, 'consulta exame Sarampo', 'V', 'consulta exame de Sarampo');

INSERT INTO laboratorio_servico (id_servico, nome, classe, descricao)
VALUES (5, 'remove exame', 'R', 'remove algum exame');

INSERT INTO laboratorio_servico (id_servico, nome, classe, descricao)
VALUES (6, 'altera exame', 'A', 'altera algum exame');

INSERT INTO laboratorio_servico (id_servico, nome, classe, descricao)
VALUES (7, 'insere exame', 'I', 'insere algum exame');


-- INTO PODE FAZER
INSERT INTO laboratorio_pode_fazer (id_perfil, id_servico)
VALUES (2, 1);
...
-- INTO TUTELAMENTO
INSERT INTO laboratorio_tutelamento (id_tutor, id_tutorado, id_perfil, id_servico, data_inicio) 
VALUES (1, 5, 2, 2, TO_DATE('01/06/2020', 'DD/MM/YYYY'));
UPDATE laboratorio_usuario SET id_tutor = 1 WHERE id_usuario = 5;

INSERT INTO laboratorio_tutelamento (id_tutor, id_tutorado, id_perfil, id_servico, data_inicio) 
VALUES (1, 4, 2, 2, TO_DATE('12/05/2020', 'DD/MM/YYYY'));
UPDATE laboratorio_usuario SET id_tutor = 1 WHERE id_usuario = 4;

INSERT INTO laboratorio_tutelamento (id_tutor, id_tutorado, id_perfil, id_servico, data_inicio) 
VALUES (6, 3, 4, 7, TO_DATE('01/01/2020', 'DD/MM/YYYY'));
UPDATE laboratorio_usuario SET id_tutor = 6 WHERE id_usuario = 3;

-- INTO PACIENTE
INSERT INTO laboratorio_pessoa (id_pessoa, nome, cpf, data_nasc, endereco)
VALUES (91, 'Carolina Marques', 46261250006, TO_DATE('24/08/2000', 'DD/MM/YYYY'), 'São paulo');
INSERT INTO laboratorio_paciente (id_paciente)
VALUES (91);

INSERT INTO laboratorio_pessoa (id_pessoa, nome, cpf, endereco)
...
-- INTO EXAME
INSERT INTO laboratorio_exame (id_exame, tipo, virus)
...
-- INTO AMOSTRA
INSERT INTO laboratorio_amostra (codigo_amostra, id_paciente, id_exame, metodo_coleta, tipo_material)
...
-- INTO REALIZA 
INSERT INTO laboratorio_realiza (id_paciente, id_exame, data_solicitacao, data_realizacao, codigo_amostra)
...
-- INTO USA
INSERT INTO laboratorio_usa (id_servico, id_exame)
VALUES (1, 1);
...
-- INTO UTILIZOU
INSERT INTO laboratorio_utilizou (id_utilizacao, id_usuario, id_servico, id_exame, data_utilizacao)
