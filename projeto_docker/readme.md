...
- Pra rodar o bixo basta invocar `docker-compose up`
...
- Tem que dar `sudo chown -R $USER:$USER .` pra arrumar as permissões das coisas que são criadas dentro do docker
